...
public class PerusteAIPEOppiaineDto {
    private Long id;
    ...
    private List<PerusteAIPEOpetuksentavoiteDto> tavoitteet = new ArrayList<>();
    private List<PerusteKeskeinensisaltoalueDto> sisaltoalueet = new ArrayList<>();
    private List<PerusteAIPEKurssiDto> kurssit = new ArrayList<>();
    private List<PerusteAIPEOppiaineDto> oppimaarat = new ArrayList<>();
}
